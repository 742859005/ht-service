...
<form class="layui-form"  style="text-align:center;"  method="post" 
 action=<c:if test="${ma==null }">"${pageContext.request.contextPath }/YJ_insertcc.do"</c:if>  
	 	<c:if test="${ma!=null }">"${pageContext.request.contextPath }/YJ_updatecc.do"</c:if>
        >
  ...
  <div class="layui-inline" style="display: none">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="business_id" name="business_id"  value="${ma.business_id} " >
      </div>
      </div>
  
   <label class="layui-form-label">出差时间</label>
      <div class="layui-input-inline">
        <input type="text" id="attendance_time" name="business_date" value="${ma.business_date}" <c:if test="${ma!=null }"> readonly="true"</c:if> class="layui-input" id="test2" placeholder="请选择年份">
      </div>
  ...
  <div class="layui-form-item">
   <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="test6" name="business_starttime"  value="${ma.business_starttime} " placeholder="yyyy-MM-dd HH:mm:ss">
      </div>
      
       
      <label class="layui-form-label">结束时间</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="test7" name="business_endtime" value="${ma.business_endtime} " placeholder="yyyy-MM-dd HH:mm:ss">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea placeholder="请输入内容" id="business_note" name="business_note"  class="layui-textarea">${ma.business_note}</textarea>
    </div>
  </div>
