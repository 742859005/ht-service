...
<form class="layui-form"  style="text-align:center;"  method="post" 
 action=<c:if test="${ma==null }">"${pageContext.request.contextPath }/YJ_insertxj.do"</c:if>  
	 	<c:if test="${ma!=null }">"${pageContext.request.contextPath }/YJ_updatexj.do"</c:if>
        >
  ...
  <div class="layui-inline" style="display: none">
      <label class="layui-form-label">休假id</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="Leave__id" name="Leave__id"  value="${ma.Leave__id} " >
      </div>
      </div>
  
   <label class="layui-form-label">休假时间</label>
      <div class="layui-input-inline">
        <input type="text" id="attendance_time" name="Leave_date" value="${ma.Leave_date}" <c:if test="${ma!=null }"> readonly="true"</c:if> class="layui-input" id="test2" placeholder="请选择年份">
      </div>
  ...
  <div class="layui-form-item">
   <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="test6" name="Leave_starttime"  value="${ma.Leave_starttime} " placeholder="yyyy-MM-dd HH:mm:ss">
      </div>
      
       
      <label class="layui-form-label">结束时间</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="test7" name="Leave_endtime" value="${ma.Leave_endtime} " placeholder="yyyy-MM-dd HH:mm:ss">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">休假备注</label>
    <div class="layui-input-block">
      <textarea placeholder="请输入内容" id="Leave_note" name="Leave_note"    class="layui-textarea">${ma.Leave_note}</textarea>
    </div>
  </div>
