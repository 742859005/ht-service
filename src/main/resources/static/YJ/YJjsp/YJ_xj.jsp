	...
	//layui日期选择器的下拉框控件
	 ...
	 var tbl= table.render({
		 title:false,
		  elem: '#test',
			  method : "post"
			    ,url:'${pageContext.request.contextPath }/YJ_allxjxx.do'
			    ,limits : [ 5, 10, 15, 20 ]
				,limit : 10
	    ...
	    ,cols: [[
	      ...
	      ,{field:'Leave__id', title:'id', width:120, fixed: 'left',hide:true, align:'center'}
	      ,{field:'name', title:'员工姓名', width:120, edit: 'text', align:'center'}
	      ,{field:'Leave_starttime', title:'开始时间', width:180 ,edit: 'text', align:'center'
	    	  ,templet:function(d){
					return layui.util.toDateString(d.attendance_time, 'yyyy年MM月dd日 ');}  
	      }
	      ,{field:'Leave_endtime', title:'结束时间', width:180 ,edit: 'text', align:'center'
	    	  ,templet:function(d){
				return layui.util.toDateString(d.attendance_time, 'yyyy年MM月dd日 ');}}
	      ,{field:'Leave_type', title:'加班类型', width:120, edit: 'text', align:'center'}
	 ...
	 //操作点击事件
		table.on('tool(test)', function(obj){
			...
			if('detail'==event){
				console.log(data);
		    	location.href='${pageContext.request.contextPath }/selectxjxx.do?id='+data.Leave__id;  
			}
		});
