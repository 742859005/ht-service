	...
	//layui日期选择器的下拉框控件
	 ...
	 var tbl= table.render({
		 title:false,
		  elem: '#test',
			  method : "post"
			    ,url:'${pageContext.request.contextPath }/allkqxx.do'
			    ,limits : [ 5, 10, 15, 20 ]
				,limit : 10
	    ...
	    ,cols: [[
	      ...
	      ,{field:'attendance_id', title:'id', width:120, fixed: 'left',hide:true, align:'center'}
	      ,{field:'name', title:'员工姓名', width:120, edit: 'text', align:'center'}
	      ,{field:'attendance_time', title:'考勤时间', width:180 ,edit: 'text', align:'center'
	    	  ,templet:function(d){
					return layui.util.toDateString(d.attendance_time, 'yyyy年MM月dd日 ');}  
	      }
	      ,{field:'attendance_type', title:'考勤类型', width:120, edit: 'text', align:'center'}
	 ...
	 //操作点击事件
		table.on('tool(test)', function(obj){
			...
			if('detail'==event){
				console.log(data);
		    	location.href='${pageContext.request.contextPath }/selectkqxx.do?id='+data.attendance_id;  
			}
		});
