	...
	//layui年分选择器的下拉框控件
	 ...
	 var tbl= table.render({
	    ...
	    ,cols: [[
	      ...
	      ,{field:'training_starttime', title:'开始时间', width:180 ,edit: 'text', align:'center'
	    	  ,templet:function(d){
					return layui.util.toDateString(d.training_starttime, 'yyyy年MM月dd日 ');}  
	      }
	      ,{field:'training_endtime', title:'结束时间', width:180, edit: 'text', align:'center'
	    	  ,templet:function(d){
					return layui.util.toDateString(d.training_endtime, 'yyyy年MM月dd日 ');}   
	      }
	      ,{field:'training_date', title:'计划年份', width:120, edit: 'text', align:'center'
	    	  ,templet:function(d){
					return layui.util.toDateString(d.training_date, 'yyyy年 ');}   
	      }
	      ,{field:'training_place', title:'计划地点', width:100, edit: 'text', align:'center'}
	      ,{field:'lecturer_name', title:'计划讲师', width:100,edit: 'text', align:'center'}
	      ,{field:'training_target', title:'计划目标', width:100,edit: 'text', align:'center'}
	      ,{field:'training_content', title:'计划内容', width:250	,edit: 'text', align:'center'}
	 ...
	 //操作点击事件
		table.on('tool(test)', function(obj){
			...
			if('detail'==event){
				console.log(data);
		    	location.href='${pageContext.request.contextPath }/selectpxjh.do?training_id='+data.training_id;  
				...
				layer.confirm('真的删除行么', function(index){
				      ...
				      layer.close(index);
				      console.log(data);
						location.href='${pageContext.request.contextPath }/deletepxjh.do?training_id='+data.training_id; 
				});
